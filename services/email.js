...
async function sendWelcomeEmail(employeeData) {
  const { name, email, position, startDate, employeeId, department, loginEmail, tempPassword } = employeeData;

  const mailOptions = {
    from: '"Suhtech Pvt Ltd HR Team" <no-reply@suhtech.in>',
    to: email,
    cc: 'hr@suhtech.in',
    subject: `Welcome to Suh Tech Private Limited - ${name}`,
    html: `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>Welcome to Suh Tech Private Limited</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>🎉 Welcome to Suh Tech Private Limited!</h1>
            ...
            <div class="content">
                <div class="welcome-message">
                    <h2>Dear ${name},</h2>
                    <p>On behalf of everyone at <strong>Suh Tech Private Limited</strong>, I want to extend a warm welcome to you! We are excited to have you join our dynamic team and look forward to the fresh perspectives and expertise you'll bring to our organization.</p>
                ...
                <div class="employee-details">
                    ...
                    <div class="detail-row">
                        ...
                        <span class="detail-value">https://erp.suhtech.shop</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Login Email:</span>
                        <span class="detail-value">${loginEmail || email}</span>
                    </div>
                    <div class="detail-row">
                        <span class="detail-label">Temporary Password:</span>
                        <span class="detail-value">${tempPassword || 'Set by HR'}</span>
                    </div>
                    <p style="margin-top:12px;color:#666">For security, please change your password after your first login.</p>
                </div>

                <div class="welcome-message">
                    <h3>💼 What Makes Suhtech Special</h3>
                    <p>At Suh Tech Private Limited, we believe in fostering innovation, collaboration, and personal growth. You're joining a company that values:</p>
                    <ul>
                ...
                <strong>Suh Tech Private Limited</strong></p>
            </div>

            <div class="footer">
                <div class="contact-info">
                    <strong>Suh Tech Private Limited</strong><br>
